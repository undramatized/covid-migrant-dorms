...
def getmapdata(alldata):
    ...
    return [mapdata0, mapdata1]

# Transpose data for Area chart
def gettransdata(alldata, mapdata1):
...
# Map Chart with plotly
def getmapchart(mapdata0, mapdata1):
    # Initialize figure
    sgmap = go.Figure()
